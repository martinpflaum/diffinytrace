    ...
    def sample_ray(self, wavelength, view=0.0, M=15, R=None, shift_x=0., shift_y=0., sampling='grid', entrance_pupil=False):
        ...
        if entrance_pupil:
            ...
            if sampling == 'grid':
                ...
                r = torch.linspace(0, R, M, device=self.device) #wrong needs to have torch.sqrt()
            ...
            if sampling == 'grid':
                ...
                r = np.sqrt(mersenne_twister.uniform(0,1,size=M**2))*R
                theta = mersenne_twister.uniform(0, 2*np.pi, M**2)
